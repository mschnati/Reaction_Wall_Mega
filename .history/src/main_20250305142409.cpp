...
U8G2_SH1106_128X64_NONAME_1_HW_I2C oled(U8G2_R0, -1, U8X8_PIN_NONE);
...
void setup() {
    ...
    oled.setCursor(0, 1);
    oled.println("This is a test");
    oled.setCursor(0, 2);
    oled.println("three lines");
    oled.println("four lines");
    oled.println("five lines");
    oled.println("six lines");
    oled.update();
    delay(2000);
